...
mkdir -p "$TEKTON_DIR/Hephaestus/hephaestus/ui/static/component"

# Copy component template to Hephaestus
TEMPLATE_SOURCE="$CODEX_DIR/ui/component_template.html"
TEMPLATE_DEST="$TEKTON_DIR/Hephaestus/hephaestus/ui/static/component/codex.html"
